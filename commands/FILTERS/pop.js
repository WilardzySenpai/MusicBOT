...
if (!args[0]) {
	player.setEQ([{
        ...
        const msg = await message.channel.send(`<a:Loading_Color:916880909452599336>Turning on **pop**.`);
		...
		const msg = await message.channel.send(`<a:Loading_Color:916880909452599336>Turning off **pop**.`);
			const embed = new MessageEmbed()
