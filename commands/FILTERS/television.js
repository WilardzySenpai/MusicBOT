...
if (!args[0]) {
			...
			const msg = await message.channel.send(`<a:Loading_Color:916880909452599336>Turning on **Television mode**.`);
	...
	player.setEQ(Array(13).fill(0).map((n, i) => ({
        ...
        const msg = await message.channel.send(`<a:Loading_Color:916880909452599336>Turning off **television mode**.`);
			const embed = new MessageEmbed()
