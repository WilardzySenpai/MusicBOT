...
if (!args[0]) {
        ...
        ]);	const msg = await message.channel.send(`<a:Loading_Color:916880909452599336>Turning on **bassboost**.`);
		...
		const msg = await message.channel.send(`<a:Loading_Color:916880909452599336>Turning off **bassboost**.`);
