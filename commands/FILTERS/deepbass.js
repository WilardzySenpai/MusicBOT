...
player.setEQ([{
        ...
        const msg = await message.channel.send(`<a:Loading_Color:916880909452599336>Turning on **deepbass**.`);
		...
		player.clearEffects()
		const msg = await message.channel.send(`<a:Loading_Color:916880909452599336>Turning off **deepbass**.`);
			const embed = new MessageEmbed()
